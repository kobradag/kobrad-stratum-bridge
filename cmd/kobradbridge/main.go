...
import (
	"flag"
	"github.com/kobradag/kobrad-stratum-bride/src/kobradstratum"
	"io/ioutil"
	"log"
	"os"
	"path"
...
func main() {
	...
	cfg := kobradstratum.BridgeConfig{}
	...
	log.Printf("\tkobra:          %s", cfg.RPCServer)
	...
	if err := kobradstratum.ListenAndServe(cfg); err != nil {
		log.Println(err)
	}
}
